    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div class="mb-12">
                ...
                <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                    These Terms shall be governed by and construed in accordance with the laws of the United States, without regard to its conflict of law provisions. Any disputes arising from these Terms or your use of the Platform shall be subject to the exclusive jurisdiction of the courts located in Digital City, DC.
                </p>
            </div>
            ...
            <div class="mb-12 bg-gradient-to-r from-blue-600 to-purple-600 p-8 rounded-2xl text-white">
                ...
                <div class="space-y-2 text-blue-100">
                    <p><strong>Email:</strong> legal@Trading Floor.com</p>
